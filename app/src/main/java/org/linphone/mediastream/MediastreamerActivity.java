...
public class MediastreamerActivity extends Activity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		if(item.getItemId()==R.id.videocall_menu_exit){
			this.finish();
		}else if(item.getItemId()==R.id.videocall_menu_change_camera){
		...
		}else if(item.getItemId()==R.id.videocall_menu_codec_vp8){
			updateVideoCodec(VP8_MIME_TYPE);
		}else if(item.getItemId()==R.id.videocall_menu_codec_mpeg4){
			updateVideoCodec(MPEG4_MIME_TYPE);
		}else if(item.getItemId()==R.id.videocall_menu_bitrate_64_kbps){
			updateBitrate(64);
		}else if(item.getItemId()==R.id.videocall_menu_bitrate_128_kbps){
			updateBitrate(128);
		}else if(item.getItemId()==R.id.videocall_menu_bitrate_256_kbps){
			updateBitrate(256);
		}else if(item.getItemId()==R.id.videocall_menu_bitrate_512_kbps){
			updateBitrate(512);
		}else if(item.getItemId()==R.id.videocall_menu_bitrate_1024_kbps){
			updateBitrate(1024);
		}
		return true;
	}
