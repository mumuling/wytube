...
public class LinphonePreferences {
    ...
    public static class AccountBuilder {
        ...
        public AccountBuilder setProxy(String proxy) {
            android.util.Log.e(this.getClass().toString(), proxy);
            tempProxy = proxy;
            return this;
        }
        ...
        public void saveNewAccount() throws LinphoneCoreException {
            ...
            tempExpire = "180";
            tempTransport = TransportType.LinphoneTransportTcp;
            String proxy = "sip:";
            if (tempProxy == null) {
                proxy += tempDomain;
            } else {
    ...
    public void setAccountTransport(int n, String transport) {
        ...
        if (proxyConfig != null && transport != null) {
            ...
            try {
                ...
                android.util.Log.e(this.getClass().toString(), proxyAddr.asStringUriOnly());
                prxCfg.done();
    ...
    public String getAccountDomain(int n) {
        if (getProxyConfig(n) == null) return null;
