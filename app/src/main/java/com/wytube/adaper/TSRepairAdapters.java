...
import com.wytube.activity.TSRepairInfoActivity;
...
public class TSRepairAdapters extends BaseAdapter {

    Context context;
    viewHolder mholder;
    private List<BaseLbrepair.DataBean> list;

    public TSRepairAdapters(Context mContext, List<BaseLbrepair.DataBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        BaseLbrepair.DataBean bean = list.get(position);
        ...
        mholder.repairState.setText(bean.getSuitStateName());
        mholder.repairType.setText(bean.getSuitTypeName());
        mholder.conText.setText(bean.getSuitContent());
        mholder.dateTiime.setText(bean.getStarttime());
        mholder.repairItem.setOnClickListener(v -> {
            AppValue.lbBeansitem = bean;
            Intent intent = new Intent(context, TSRepairInfoActivity.class);
    ...
    public void setBeans(List<BaseLbrepair.DataBean> beans) {
        this.list = beans;
    }
}
