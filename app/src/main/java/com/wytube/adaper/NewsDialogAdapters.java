...
public class NewsDialogAdapters extends BaseAdapter {
    Context mContext;
    viewHolder mholder;
    private List<NewsTypeBean.DataBean> list;

    public NewsDialogAdapters(Context mContext, List<NewsTypeBean.DataBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        NewsTypeBean.DataBean bean = list.get(position);
