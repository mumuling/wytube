...
import com.cqxb.yecall.zhifubao.Keys;
import com.cqxb.yecall.zhifubao.Rsa;
...
public class Result {
    ...
    public static String resultStatusReplace = "";
    ...
    public void parseResult() {
        ...
        try {
            ...
            resultStatusReplace = resultStatus;
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
