...
public class BaseAlipay {
	 ...
	 * @param subject 充值的金额
	 */
	public BaseAlipay(Activity act,Handler handler,String order,String url,String phone,String money,String sub){
		activity=act;
		mHandler=handler;
		orderInfo=order;
		backurl=url;
	...
	//	sb.append(sProducts[position].body);
		sb.append(SettingInfo.getAccount()+","+number);
		sb.append("\"&total_fee=\"");
		sb.append(mMoney);
	...
	//	sb.append(URLEncoder.encode("http://notify.java.jpxx.org/index.jsp"));
		sb.append(URLEncoder.encode(NetParam.SERVER+NetParam.SERVER_NAME+"/"+backurl));
