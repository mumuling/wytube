...
public class CircleProgress extends View {
	...
	private void initAttrs(Context context, AttributeSet attrs) {
		...
		mRadius = typeArray.getDimension(
				R.styleable.CircleProgress_radiusProgress, 10);
		mStrokeWidth = typeArray.getDimension(
				R.styleable.CircleProgress_strokeWidthProgress, 4);
		mCircleColor = typeArray.getColor(
				R.styleable.CircleProgress_circleColorProgress, 0xFFFFFFFF);
		mRingColor = typeArray.getColor(
				R.styleable.CircleProgress_ringColorProgress, 0xFFFFFFFF);
	...
	private void initVariable() {
		...
		mTextPaint.setARGB(255, 84, 171, 238);
		mTextPaint.setTextSize(mRadius / 2 + 2);
